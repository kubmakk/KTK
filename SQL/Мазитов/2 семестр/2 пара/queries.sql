...
select * from client where clientcol in ('vip', 'premium');
select * from client where balance between 100.00 and 1500.00;
select * from client where login like '%gamer%';
select * from client where phone regexp '^(8900|8911)';
select * from client where updatedat is null;

select * from employee where position in ('administrator', 'manager');
select * from employee where createdat between '2024-01-01 00:00:00' and '2026-12-31 23:59:59';
select * from employee where full_lastname like 'смирн%';
select * from employee where rights regexp '^full$|^edit$';
select * from employee where full_patronymic is null;

select * from pc where zone in ('vip', 'bootcamp');
select * from pc where number between 11 and 13;
select * from pc where configure like '%rtx 4090%';
select * from pc where status regexp 'free|maintenance';
select * from pc where updatedby is null;

select * from service where type in ('food', 'rent');
select * from service where price between 150.00 and 300.00;
select * from service where name like '%coffee%';
select * from service where name regexp 'tariff|hour';
select * from service where createdat is null;

select * from sessie where employee_id in (1, 2);
select * from sessie where cost between 300.00 and 600.00;
select * from sessie where createdby like 'admin%';
select * from sessie where start_time regexp '10:00:00|12:00:00';
select * from sessie where end_time is null;

select * from purshes where service_id in (3, 4, 5);
select * from purshes where client_id between 1 and 3;
select * from purshes where description like '%energy%';
select * from purshes where description regexp 'вип|экспрессо';
select * from purshes where employee_id is null;